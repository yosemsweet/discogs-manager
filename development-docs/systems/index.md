...
| [Playlist Management](playlist-management/documentation.md) | `src/services/playlist*.ts`, `src/commands/playlist.ts`, `src/commands/review.ts`, `src/commands/export.ts`, `src/commands/lookup.ts` | Creates, updates, deletes, and exports SoundCloud playlists; reverse URL lookup |
